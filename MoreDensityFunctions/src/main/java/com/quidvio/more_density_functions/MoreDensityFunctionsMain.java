...
public class MoreDensityFunctionsMain implements ModInitializer {
  ...
  public void onInitialize() {
    Registry.register(Registry.DENSITY_FUNCTION_TYPE, new Identifier("more_dfs", "x_clamped_gradient"),
        XClampedGradient.CODEC.codec());
    Registry.register(Registry.DENSITY_FUNCTION_TYPE, new Identifier("more_dfs", "z_clamped_gradient"),
    ...
    Registry.register(Registry.DENSITY_FUNCTION_TYPE, new Identifier("more_dfs", "floor_div"),
        FloorDivision.CODEC.codec());
    Registry.register(Registry.DENSITY_FUNCTION_TYPE, new Identifier("more_dfs", "mod"), Modulo.CODEC.codec());
    Registry.register(Registry.DENSITY_FUNCTION_TYPE, new Identifier("more_dfs", "floor_mod"),
        FloorModulo.CODEC.codec());
    Registry.register(Registry.DENSITY_FUNCTION_TYPE, new Identifier("more_dfs", "reciprocal"),
        Reciprocal.CODEC.codec());
    Registry.register(Registry.DENSITY_FUNCTION_TYPE, new Identifier("more_dfs", "shift_df"),
